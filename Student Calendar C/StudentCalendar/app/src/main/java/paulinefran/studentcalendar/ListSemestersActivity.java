...
public class ListSemestersActivity extends Activity implements View.OnClickListener {
                ...
                if(data != null) {
                    ...
                    if(createdSemester != null) {
                        ...
                        if(mAdapter == null) {
                            mAdapter = new ListSemestersAdapter(this, mListSemesters);
                            mListviewSemesters.setAdapter(mAdapter);
                            mListviewSemesters.setOnItemClickListener(new OnItemClickListener(){
                                @Override
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                                    Semester clickedSemester = mAdapter.getItem(position);
                                    Log.d(TAG, "clickedItem : " + clickedSemester.getName());
                                    Intent intent = new Intent(ListSemestersActivity.this, ListCoursesActivity.class);
                                    intent.putExtra(ListCoursesActivity.EXTRA_SELECTED_SEMESTER_ID, clickedSemester.getId());
                                    startActivity(intent);
                                }
                            });
                            mListviewSemesters.setOnItemLongClickListener(new OnItemLongClickListener(){
                                @Override
